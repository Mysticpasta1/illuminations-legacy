...
public class PoltergeistParticle extends WillOWispParticle {
    protected PoltergeistParticle(ClientLevel world, double x, double y, double z, ResourceLocation texture, float red, float green, float blue, float redEvolution, float greenEvolution, float blueEvolution) {
    ...
    public void render(VertexConsumer vertexConsumer, Camera camera, float tickDelta) {
        ...
        if (this.alpha > 0.0F) {
            this.model.renderToBuffer(matrixStack, vertexConsumer2, 15728880, OverlayTexture.NO_OVERLAY, 1.0F, 1.0F, 1.0F, 0.5F);
        }
