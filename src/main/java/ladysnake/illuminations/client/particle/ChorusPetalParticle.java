...
public class ChorusPetalParticle extends TextureSheetParticle {
    ...
    public ChorusPetalParticle(ClientLevel world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, SpriteSet spriteProvider) {
        ...
        this.yd = velocityY - 0.15 - (double)(this.random.nextFloat() / 10.0F);
        this.xd = velocityX - 0.05 - (double)(this.random.nextFloat() / 10.0F);
        this.zd = velocityZ - 0.05 - (double)(this.random.nextFloat() / 10.0F);
